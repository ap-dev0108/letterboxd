        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageRatings = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<Guid>(type: "uuid", nullable: false),
                    MovieRatedmovieId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieGenreGenreId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmGenre", x => new { x.FilmsmovieId, x.MovieGenreGenreId });
                    table.ForeignKey(
                        name: "FK_FilmGenre_Films_FilmsmovieId",
                        column: x => x.FilmsmovieId,
                        principalTable: "Films",
                        principalColumn: "movieId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilmGenre_Genres_MovieGenreGenreId",
                        column: x => x.MovieGenreGenreId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilmGenre_MovieGenreGenreId",
                table: "FilmGenre",
                column: "MovieGenreGenreId");
